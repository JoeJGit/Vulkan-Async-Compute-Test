...
namespace ImGui
{
	...
	// @@@
    IMGUI_API void          RangeBar(float fraction0, float fraction1, const ImVec2& size_arg, ImU32 color);
    ...
    IMGUI_API bool          InputFloat(const char* label, float* v, float step = 0.0f, float step_fast = 0.0f, int decimal_precision = -1, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputFloat2(const char* label, float v[2], int decimal_precision = -1, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputFloat3(const char* label, float v[3], int decimal_precision = -1, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputFloat4(const char* label, float v[4], int decimal_precision = -1, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputInt(const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputInt2(const char* label, int v[2], ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputInt3(const char* label, int v[3], ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
    IMGUI_API bool          InputInt4(const char* label, int v[4], ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);


//IMGUI_API bool	InputIntS (const char* label, int* v, int step = 1, int step_fast = 100, ImGuiInputTextFlags extra_flags = ImGuiInputTextFlags_EnterReturnsTrue);
